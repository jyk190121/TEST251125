...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DataManager.MoneyChanged += updateMoneyUI;
    }
    ...
    //{
        ...
        //// 단축키 UI 텍스트 업데이트
        //PlayerPortionText.text = $"{KeySetting.keys[KeyInput.PENDANT]}";     // 포션 or 펜던트
        ...
        //PlayerInvetoryText.text = $"{KeySetting.keys[KeyInput.INTERACTIVE]}";    // 인벤토리 키가 따로 있다면 수정
    //}

    public void updateMoneyUI()
    {
        player.Money = _MasterManager.Instance.DataManager.HojuMoney();
    }
