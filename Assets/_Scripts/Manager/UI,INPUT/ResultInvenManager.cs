...
[RequireComponent(typeof(ResultInvenManager))]
public class ResultInvenManager : MonoBehaviour
{
    public static ResultInvenManager Instance;
    ...
    public ResultInvenView inventoryView;
